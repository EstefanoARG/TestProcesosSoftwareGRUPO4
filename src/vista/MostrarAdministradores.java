 ...
 * @author Luis Bizarro
 */
public class MostrarAdministradores extends javax.swing.JFrame {

    /**
     * Creates new form Test
     */
    int xMouse, yMouse;
    public MostrarAdministradores() {
        ...
        event = new TableActionEvent() {
            ...
            @Override
            //Este es para el boton de borrar que esta en la tabla
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID ADMINISTRADOR", "NOMBRE", "USUARIO", "ACCION"
            }
        ) {
        ...
        lblPedidos.setText("Administrador");
    ...
    private void cargarEmpleadosEnTabla() {
        ...
        int count = 0;
        for (Personal p : trabajadores) {
            if ("Administrador".equals(p.getRol())) {
                count++;
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarAdministradores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarAdministradores().setVisible(true);
